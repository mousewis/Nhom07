...
<form action="<?= url('nguoidung/store') ?>" method="POST" class="form-horizontal">
	<fieldset>
		<div class="form-group"><!----<label class="control-label">Tên người dùng:</label>--->
		<input type="text" name="nd_email" required ='required' class="col-md-4 form-control" placeholder="Tên người dùng"></div>
    	 <div class="form-group"><!---<label class="control-label">Email</label>--->
		<input type="text" name="nd_email" required ='required' class="col-md-4 form-control" placeholder="Email"></div>
		<div class="form-group"><!----<label class="control-label">Mật khẩu</label>-->
		<input type="text" name="nd_matkhau" required ='required' class="col-md-4 form-control" placeholder="Mật khẩu"></div>
