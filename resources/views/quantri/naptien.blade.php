...
@section('content')
    ...
    <div class="col-sm-9 padding-right text-center">
        <div class="signup-form"><!--sign up form-->
            ...
            <table>
                <tr>
                    <form action="{{url('quantri/naptien')}}" method="get">
                        <td>Sắp xếp theo:</td>
                        <td>
                            <select name="col">
            ...
            <table>
                    <form name="timkiem" action="{{url('quantri/naptien')}}" method="get">
                        <tr>
                        <td>
                        ...
                        <tr>
                        <td colspan="3">Người bán:
                            <select name="hdtk_nguoidung">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="total_area">
                                <ul>
                                    <li style="color: #D62617;font-size:22px;">Số lượng:
                                        <span><?= (isset($hoadontk_count))?$hoadontk_count:'0' ?></span></li>
                                    <li style="color: #D62617;font-size:22px;">Tổng giá trị:
                                        <span><?= (isset($hoadontk_sum))?$hoadontk_sum:'0' ?></span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
