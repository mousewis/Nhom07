					...
					<form action="" method="">
						<div class="col-sm-6">
							...
							<p><input type="radio" name="type" value="0" checked onclick="type_0();"/>Sử dụng thông tin có sẵn</p>
								<input name="nd_hoten" type="text" placeholder="Họ tên" readonly>
								<input name="nd_dchi" type="text" placeholder="Địa chỉ *" readonly>
								<input name="nd_sdt" type="text" placeholder="Số điện thoại *" readonly>
								<br><br>
								</div>
						</div>
